...
use crate::twocut::rooted::{StableRootedDynamicForest, StandardRootedDynamicForest};
...
/// A rooted dynamic forest using [GreedySplayStrategy] as a stable strategy.
pub type RootedStableGreedySplayTT = StableRootedDynamicForest<GreedySplayStrategy>;
...
/// A dynamic tree using [TwoPassSplayStrategy] as a stable strategy.
...
/// A dynamic tree using [TwoPassSplayStrategy] as a stable strategy with monoid edge weights.
pub type MonoidStableTwoPassSplayTT<TWeight> = StableTwoPassSplayTT<MonoidPathWeightNodeData<TWeight>>;
/// A dynamic tree using [TwoPassSplayStrategy] as a stable strategy with group edge weights.
pub type GroupStableTwoPassSplayTT<TWeight> = StableTwoPassSplayTT<GroupPathWeightNodeData<TWeight>>;
/// A dynamic tree using [TwoPassSplayStrategy] as a stable strategy without edge weights.
...
/// A rooted dynamic forest using [TwoPassSplayStrategy] as a stable strategy.
pub type RootedStableTwoPassSplayTT = StableRootedDynamicForest<TwoPassSplayStrategy>;
...
/// A dynamic tree using [LocalTwoPassSplayStrategy] as a stable strategy.
...
/// A dynamic tree using [LocalTwoPassSplayStrategy] as a stable strategy with monoid edge weights.
pub type MonoidStableLocalTwoPassSplayTT<TWeight> = StableLocalTwoPassSplayTT<MonoidPathWeightNodeData<TWeight>>;
/// A dynamic tree using [LocalTwoPassSplayStrategy] as a stable strategy with group edge weights.
pub type GroupStableLocalTwoPassSplayTT<TWeight> = StableLocalTwoPassSplayTT<GroupPathWeightNodeData<TWeight>>;
/// A dynamic tree using [LocalTwoPassSplayStrategy] as a stable strategy without edge weights.
...
/// A rooted dynamic forest using [LocalTwoPassSplayStrategy] as a stable strategy.
pub type RootedStableLocalTwoPassSplayTT = StableRootedDynamicForest<LocalTwoPassSplayStrategy>;
