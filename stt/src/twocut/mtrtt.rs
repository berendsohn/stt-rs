...
/// A rooted dynamic forest using a simple move-to-root strategy (stable variant).
pub type RootedStableMoveToRootTT = StableRootedDynamicForest<MoveToRootStrategy>;
